...
if($get_session!='7-7-7-7') {
    header("Location: https://www.sigefa.com/");
}
?>
<!DOCTYPE html>
<html>
					...
					<div id="multi-step-form-container" class="twostepform">
                        ...
                        <form id="ContactForm" name="ContactForm" enctype="multipart/form-data" method="POST">
                            ...
                            <section id="step-4" class="form-step d-none">
                                <div class="form-q">
                                    <h2 class="font-normal">Would one FREE deep-dive coaching call be a bad use of your time?<sup>*</sup></h2>
                                    <!-- Step 4 input fields -->
                                    <div class="mt-3">
                                        <div class="row">
                                            <div class="col-md-12">
                        ...
                        <div class="col-12 px-0">
                            ...
                            <div class="container">
                                <div class="position-relative">
                                    <!--<h3 class="mb">YOU WERE BORN FOR MORE THAN JUST SURVIVAL</h3>-->
                                    <h3 class="mb"><span>Entrepreneurial&nbsp;</span>Coaching Agency</h3>
                                    
                                    <div class="text-end mb-2 show-mobile pab">
                                        <img onclick="expand_all()" id="expand2" src="images/expand.png" width="25">
                                        <img onclick="collapse_all()" id="collapse2" src="images/collapse.png" width="25">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container text-end">
                                <div class="row">
                                    <div class="col-md-12">
                                        <!--<button type="button" class="mb-3 me-1 btn btn-info btn-sty dnone" id="expand" onclick="expand_all()">Expand All</button>-->
                                        <!--<button type="button" class="mb-3 me-1 btn btn-info btn-sty dnone" id="collapse" onclick="collapse_all()">Collapse All</button>-->
                                    </div>
                                </div>
                            </div>
                            <div class="acd">
                                <div class="accordion accoscrol" id="accordionExample">
                                                    ...
                                                    <h2 class="accordion-header dfh play-button apt" id="headingOne">
                                                        <button id="play-button" class="accordion-button videoModalTriger" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                            <div class="d-flex justify-content-between align-items-center  w-100 pr10">
                                                                <div class="d-flex align-items-center intro"> Intro......... Welcome to... the Brand of YOU!</div>
                                                                <div class="b-hold">
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse df collapse submenu fstdflt show  " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body ">
                                                            <div class="row pad-hundred g-4 mx-2 align-items-center text-center acco-inner-body">
                                                                ...
                                                                <!--    <div><img src="images/determin.jpg" class="img-fluid  ms-lg-auto  d-block whtbdr"></div>-->
                                                                <!--</div>-->
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="position-relative">
                                        <img class="img-fluid lck d-none" src="images/lock.png">
                                        <!-- accodian two start -->
                                                                ...
                                                                <button class="accordion-button collapsed video-btn2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                    <div class="d-flex justify-content-between align-items-center  w-100 pr10">
                                                                        <div class="d-flex align-items-center flex-wrap accor-width">
                                                                            <span class="brwn d-inline-block">WHY </span>........ The <span class="txtsky">&nbsp;Philosophy&nbsp;</span> we stand for is...
                                                                        </div>
                                                                        <div class="parent_img">
                                                                            <div class="form-group">
                                                            ...
                                                            <div id="collapseTwo" class="accordion-collapse df collapse submenu" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                                <div class="accordion-body sect">
                                                                    <div class="row pad-hundred g-4   mx-2 text-center align-items-center acco-inner-body">
                                                                        <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 px-lg-0">
                                                                            <div>
                                                                                <h3 class="mb-4">All of creation is filled with An eager anticipation for the revelation of... who you are.</h3>
                                                                            </div>
                                                                        ...
                                                                        <!--    <div><img src="images/determin2.jpg" class="img-fluid whtbdr  ms-lg-auto  d-block"></div>-->
                                                                        <!--</div>-->
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <button class="accordion-button collapsed video-btn3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                                    <div class="d-flex justify-content-between align-items-center  w-100 pr10">
                                                                        <div class="d-flex align-items-center flex-wrap">
                                                                            <span class="brwn d-inline-block">WHAT</span>...... The <span class="txtsky">&nbsp;Problem</span>&nbsp;we solve is...
                                                                        </div>
                                                                        <div class="parent_img">
                                                                            <div class="form-group">
                                                                ...
                                                                <div class="accordion-body sect">
                                                                    <div class="row pad-hundred g-4 text-center  mx-2  align-items-center acco-inner-body">
                                                                        <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 px-lg-0">
                                                                            <div class="step-1-right-vid video-com rounded ">
                                                                                <div>
                                                                                    <h3>Good offerings ought not have weak branding.</h3>
                                                                                    <p>How to prevent your branding from betraying your offer.</p>
                                                                                </div>
                                                                                <div class="box-video">
                                                                                    <div class="video-container rounded">
                                                                                        <iframe class="rounded" style="background-image:url(images/man.png);background-size:contain;background-repeat: no-repeat;    background-position: center; " id="three_acc" width="100%" height="100%" src="https://player.vimeo.com/video/641467347?" frameborder="0" allowfullscreen="allowfullscreen" allow="autoplay"></iframe>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <!--<div class="col-md-6 col-lg-4  ">-->
                                                                        <!--    <div><img src="images/Brandoovy1.jpg" class="img-fluid whtbdr  ms-lg-auto  d-block"></div>-->
                                                                        <!--</div>-->
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="accordion-item ">
                                                            <h2 class="accordion-header dfh" id="headingfour">
                                                                <button class="accordion-button collapsed video-btn4" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
                                                                    <div class="d-flex justify-content-between align-items-center  w-100 pr10">
                                                                        <div class="d-flex align-items-center flex-wrap">
                                                                            <span class="brwn d-inline-block">WHO</span>........ The <span class="txtsky">&nbsp;people&nbsp;</span>we work with are...
                                                                        </div>
                                                                        <div class="parent_img">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        <div class="row pad-hundred g-4   mx-2 text-center align-items-center acco-inner-body">
                                                                            <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 px-lg-0">
                                                                                <div class="step-1-right-vid video-com rounded ">
                                                                                    <div>
                                                                                        <h3>Red-Pilled Innovators.</h3>
                                                                                        <p>How to have eyes to see</p>
                                                                                    </div>
                                                                                    <div class="box-video">
                                                                                        <div class="video-container">
                                                                            ...
                                                                            <!--<div class="col-md-6 col-lg-4  ">-->
                                                                            <!--    <div><img src="images/The-5-Freedoms.jpg" class="img-fluid whtbdr ms-lg-auto  d-block"></div>-->
                                                                            <!--</div>-->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="accordion-item ">
                                                            <h2 class="accordion-header dfh" id="headingfive">
                                                                <button class="accordion-button collapsed video-btn5" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                                                                    <div class="d-flex justify-content-between align-items-center  w-100 pr10">
                                                                        <div class="d-flex align-items-center  flex-wrap"> <span class="brwn d-inline-block">WHere</span>.... The <span class="txtsky">&nbsp;place&nbsp;</span>from where we function is... </div>
                                                                        <div class="parent_img">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        <div class="row pad-hundred g-4  text-center  align-items-center acco-inner-body">
                                                                            <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 px-lg-0">
                                                                                <div class="step-1-right-vid video-com rounded ">
                                                                                    <div>
                                                                                        <h3>From Influence</h3>
                                                                                        <p>The 7 Mountains Culture</p>
                                                                                    </div>
                                                                                    <div class="box-video">
                                                                                        <div class="video-container">
                                                                            ...
                                                                            <!--<div class="col-md-6 col-lg-4  ">-->
                                                                            <!--    <div><img src="images/listeners-edge.jpg" class="img-fluid whtbdr ms-lg-auto  d-block"></div>-->
                                                                            <!--</div>-->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="accordion-item ">
                                                            <h2 class="accordion-header dfh" id="headingsix">
                                                                <button class="accordion-button collapsed video-btn6" type="button" data-bs-toggle="collapse" data-bs-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix">
                                                                    <div class="d-flex justify-content-between align-items-center  w-100 pr10">
                                                                        <div class="d-flex align-items-center flex-wrap "><span class="brwn d-inline-block">how</span>........ The <span class="txtsky">&nbsp;process&nbsp;</span>by which we roll is... </div>
                                                                        <div class="parent_img">
                                                                            <div class="form-group">
                                                            ...
                                                            <div id="collapsesix" class="accordion-collapse df collapse submenu" aria-labelledby="headingsix" data-bs-parent="#accordionExample">
                                                                <div class="accordion-body sect">
                                                                    <div class="">
                                                                        <div class="row pad-hundred g-4 text-center  mx-2  align-items-center acco-inner-body">
                                                                            <div class="col-lg-10 offset-lg-1 col-md-10 offset-md-1 px-lg-0">
                                                                                <div class="step-1-right-vid video-com rounded ">
                                                                                    <div>
                                                                                        <!--<h3>Collaborative, Christ-centered Consulting.</h3>-->
                                                                                        <!--<p>“For where two or three are gathered together in My name, <br>I am there in the midst of them.” (Mt. 18:20)</p>-->
                                                                                        
                                                                                        <h3>Visionary Coaching.</h3>
                                                                                        <p>The only thing that keeps you from all you're meant to BE, DO, and HAVE</p>
                                                                                        <p>is an inability to Make Better Decisions Faster.</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row pad-hundred g-4 text-center  mx-2  align-items-center acco-inner-body">
                                                                            ...
                                                                            <!--<div class="col-md-6 col-lg-4  ">-->
                                                                            <!--    <div><img src="images/determin6.jpg" class="img-fluid whtbdr  ms-lg-auto  d-block"></div>-->
                                                                            <!--</div>-->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="accordion-item ">
                                                            <h2 class="accordion-header dfh" id="headingseven">
                                                                <button class="accordion-button collapsed video-btn7" type="button" data-bs-toggle="collapse" data-bs-target="#collapseseven" aria-expanded="false" aria-controls="collapseseven">
                                                                    <div class="d-flex justify-content-between align-items-center w-100 pr10">
                                                                        <div class="d-flex align-items-center  flex-wrap ">
                                                                            <span class="brwn d-inline-block">when</span>...... The <span class="txtsky">&nbsp;price&nbsp;</span>of inaction is...
                                                                        </div>
                                                                        <div class="parent_img">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        <div class="row pad-hundred g-4 text-center  align-items-center acco-inner-body">
                                                                            <div class="col-lg-10 offset-lg-1 col-md-10 offset-md-1 px-lg-0">
                                                                                <div class="step-1-right-vid video-com rounded ">
                                                                                    <div>
                                                                                        <h3>At what point does your current branding become unbearable?</h3>
                                                                            ...
                                                                            <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 px-lg-0">
                                                                                <div>
                                                                                    <div class="box-video">
                                                                                        <div class="video-container">
                                                                                            <iframe class="rounded" style="background-image:url(./images/man.png);background-size:contain;background-repeat: no-repeat;    background-position: center; " id="seven_acc" width="100%" allow="autoplay" height="100%" src="https://player.vimeo.com/video/641467347?" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <!--            <div><img src="images/determin3.jpg" class="img-fluid ms-lg-auto whtbdr d-block"></div>-->
                                                                            <!--        </div>-->
                                                                            <!--    </div>-->
                                                                            <!--</div>-->
                                                                        </div>
                                                                        ...
                                                                        <div class="row pad-hundred g-4 text-center  align-items-center acco-inner-body">
                                                                            ...
                                                                            <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 px-lg-0">
                                                                                <div class="">
                                                                                    <div class="box-video">
                                                                                        <div class="video-container">
                                                                                            <iframe class="rounded" style="background-image:url(images/man.png);background-size:contain;background-repeat: no-repeat; background-position: center; " id="eight_acc" allow="autoplay" width="100%" height="100%" src="https://player.vimeo.com/video/641467347?" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
                                                                                        </div>
                                                                                    </div>
                                                                                    <!--<button class="btn orngjoin px-lg-4 mt-4" data-bs-toggle="modal" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-target="#contact_form" type="button">CONNECT</button>-->
                                                                                    <button class="btn orngjoin px-lg-4 mt-4 slbg" onclick="open_slidein()" type="button">CONNECT</button>
                                                                                </div>
                                                                            </div>
                                                                            <!--<div class="col-md-6 col-lg-4">-->
                                                                            ...
                                                                            <!--        <div id='msg'></div>-->
                                                                            <!--    </div>-->
                                                                            <!--    <div class="formtabsone my-lg-0 my-4">-->
                                                                            <!--        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">-->
                                                                            <!--            <li class="nav-item" role="presentation">-->
                                                                            <!--                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Let's see</button>-->
                                                                            <!--            </li>-->
                                                                            <!--            <li class="nav-item" role="presentation">-->
                                                                            <!--                <button class="nav-link not" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Not yet</button>-->
                                                                            <!--            </li>-->
                                                                            <!--        </ul>-->
                                                                            <!--        <div class="tab-content" id="pills-tabContent">-->
                                                                            <!--            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">-->
                                                                            <!--==========lets see===========-->
                                                                            <!--                <form id="letsee" method="post" class="">-->
                                                                            <!--                    <input type="hidden" name="workCJ" value="letsee">-->
                                                                            <!--                    <div class="mb-3">-->
                                                                            ...
                                                                            <!--                        <input type="text" class="form-control" name="phoneno" id="exampleInputEmail1" aria-describedby="emailHelp" required>-->
                                                                            <!--                    </div>-->
                                                                            <!--                    <div class="mb-3">-->
                                                                            <!--                        <label for="exampleInputEmail1" class="form-label">Website(optional)</label>-->
                                                                            <!--                        <input type="text" class="form-control" name="website" id="exampleInputEmail1" aria-describedby="emailHelp" required>-->
                                                                            <!--                    </div>-->
                                                                            <!--                    <button type="submit" class="btn btn-orng">JOIN</button>-->
                                                                            <!--                </form>-->
                                                                            <!--            </div>-->
                                                                            <!--            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">-->
                                                                            <!--                <form id="notyet" method="post" class="">-->
                                                                            <!--                    <p class="txtwht  py-2">If I May Ask A Curious Research Questions... Where If Anywhere Did I Miss You Winning Over To Wanting him To Work Closely Together?</p>-->
                                                                            <!--                    <input type="hidden" name="workCJ" value="notyet">-->
                                                                            <!--                    <div class="form-floating mb-3">-->
                                                                            <!--                        <textarea class="form-control border border-light" placeholder="Leave a comment here" id="floatingTextarea2" name="comment" style="height: 100px" required></textarea>-->
                                                                            <!--                        <label for="floatingTextarea2" class=" textgray ">Optional</label>-->
                                                                            <!--                    </div>-->
                                                                            <!--                    <button type="submit" class="btn btn-orng">SUBMIT</button>-->
                                                                            <!--                </form>-->
                                                                            <!--            </div>-->
                                                                            <!--        </div>-->
                                                                            <!--    </div>-->
                                    ...
                                    <!--    <div class="row ">-->
                                    <!--        <div class="col-12">-->
                                    <!--            <div class="position-relative buttons-botom">-->
                                    <!--                <button class="botombtns" id="expand" type="button">-->
                                    <!--                    <i class="bi bi-chevron-bar-expand"></i>-->
                                    <!--                </button>-->
                                    <!--                <button class="botombtns" id="expand-collapse" type="button">-->
                                    ...
                                    <div class="container text-end">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <!--<div class="container text-end mb-2 show-mobile">-->
                                                    <img onclick="expand_all()" class="show-mobile1" id="expand3" src="images/expand.png" width="25">
                                                    <img onclick="collapse_all()" class="show-mobile1" id="collapse3" src="images/collapse.png" width="25">
                                                <!--</div>-->
        ...
        <div class="row align-items-center justify-content-center gy-2">
            <div class="col-md-12 p-0">
                <div class="pb-lg-0 copyright-outer">
                    <div class="copyright">
                        <span class="copyrighttext">© 2023-2024 & Beyond Sigefa.com </span><span class="copyright-reserved">All Rights Reserved.</span><span class="legalesebtn"><h5 class="text-white cursor-pointer" onclick="open_legalese()">Legalese</h5></span>
                    </div>
                </div>
            </div>
        </div>
